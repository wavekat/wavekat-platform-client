...
## [0.0.33](https://github.com/wavekat/wavekat-platform-client/compare/v0.0.32...v0.0.33) - 2026-09-22

### Added

- [**breaking**] sync TLS account lines ([#65](https://github.com/wavekat/wavekat-platform-client/pull/65))

## [0.0.32](https://github.com/wavekat/wavekat-platform-client/compare/v0.0.31...v0.0.32) - 2026-09-16

### Fixed

- report the host OS version inside Snap and Flatpak ([#63](https://github.com/wavekat/wavekat-platform-client/pull/63))

## [0.0.31](https://github.com/wavekat/wavekat-platform-client/compare/v0.0.30...v0.0.31) - 2026-09-08

### Added

- anonymous usage events for the install ping ([#61](https://github.com/wavekat/wavekat-platform-client/pull/61))
...
- count saved lines and label sets in a deletion preview ([#55](https://github.com/wavekat/wavekat-platform-client/pull/55))
